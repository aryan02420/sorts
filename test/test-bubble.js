...
describe('bubble sort', () => {
  ...
  step('3', () => {
    expect(s.next().value.toString() === [ 4, 3, 2, 5, 1 ].toString()).to.be.true
  })
  step('4', () => {
    expect(s.next().value.toString() === [ 4, 3, 2, 1, 5 ].toString()).to.be.true
  })
  step('5', () => {
    expect(s.next().value.toString() === [ 3, 4, 2, 1, 5 ].toString()).to.be.true
  })
  step('6', () => {
    expect(s.next().value.toString() === [ 3, 2, 4, 1, 5 ].toString()).to.be.true
  })
  step('7', () => {
    expect(s.next().value.toString() === [ 3, 2, 1, 4, 5 ].toString()).to.be.true
  })
  step('8', () => {
